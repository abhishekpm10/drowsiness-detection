...
while(True):
    ...
    for (x, y, w, h) in faces:
        ...
        fc = cv2.resize(fc, (24, 24))
        fc = fc/255
        fc = fc.reshape(24, 24, -1)
        fc = np.expand_dims(fc, axis=0)
        fcpred = model.predict_classes(fc)
    ...
    if((rpred[0] == 0 and lpred[0] == 0) or fcpred == 2):
        score = score+1
        cv2.putText(frame, "Drowsy", (10, height-20), font,
                    1, (255, 255, 255), 1, cv2.LINE_AA)
    # if(rpred[0]==1 or lpred[0]==1):
    else:
        score = score-1
        cv2.putText(frame, "Awake", (10, height-20), font,
                    1, (255, 255, 255), 1, cv2.LINE_AA)
